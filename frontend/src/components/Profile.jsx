...
const GroupProfile = (props) => {
  ...
  const [groupName, setGroupName] = useState("")
    ...
    const handleEditName = async () => {
      ...
      try {
        const { data } = await axios.put(`https://chat-app-api-lake.vercel.app/api/chat/rename`, {
    ...
    useEffect(() => {
     ...
     const searchUser = async () =>{
      ...
      // console.log(inp)
      const { data } = await axios.get(`https://chat-app-api-lake.vercel.app/api/user?search=${search === "" ? null : search}`)
      console.log(data)
    ...
    const onAddUsers = async(otherUser) => {
      ...
      try {
        {/*Loading */}
        const { data } = await axios.put(`https://chat-app-api-lake.vercel.app/api/chat/groupadd`, {
          chatId: singleChat._id,
    ...
    const onRemove = async (otherUser) => {
      ...
      try {
        const { data } = await axios.put(`https://chat-app-api-lake.vercel.app/api/chat/groupremove`, {
          chatId: singleChat._id,
          userId: otherUser._id
        })
        console.log(data)
