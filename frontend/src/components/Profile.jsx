...
const GroupProfile = (props) => {
  ...
  const [groupName, setGroupName] = useState("")
    ...
    const handleEditName = async () => {
      ...
      try {
        const { data } = await axios.put(`https://chat-app-api-vzj2.onrender.com/api/chat/rename`, {
    ...
    useEffect(() => {
     ...
     const searchUser = async () =>{
      ...
      // console.log(inp)
      const { data } = await axios.get(`https://chat-app-api-vzj2.onrender.com/api/user?search=${search === "" ? null : search}`, { withCredentials: true})
      console.log(data)
    ...
    const onRemove = async (otherUser) => {
      ...
      try {
        const { data } = await axios.put(`https://chat-app-api-vzj2.onrender.com/api/chat/groupremove`, {
          chatId: singleChat._id,
          userId: otherUser._id
        }, { withCredentials: true})
        console.log(data)
