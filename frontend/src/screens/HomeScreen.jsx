...
const HomeScreen = () => {
  return (
    <div className=''>
      <div className="bg-gray-100 w-96  mx-auto mt-40 p-5">
        ...
        <Link to="/register"  style={{backgroundColor: "#10C17D"}} className='w-full block text-center py-2 text-white rounded-2xl text-lg'>Get Started</Link>
      </div>
